...
format: 
  revealjs:
    ...
    footer: "[{{< fa solid display >}}  bit.ly/quarto-params](https://jadeynryan.quarto.pub/parameterized-quarto-posit-2023/)"
...
::: {.r-stack}
![](images/ocean_floor.png){.fragment .fade-in-then-out height="700" fig-alt="RStudio RMarkdown parameterized report project for mapping ocean floors."}

![](images/urban_institute.png){.fragment .fade-in-then-out height="700" fig-alt="Report for Alabama spending with text and plots generated from parameterized RMarkdown."}

![](images/driver_quality.png){.fragment .fade-in-then-out height="700" fig-alt="Report for Alaska driver quality with text, plot, and table generated from parameterized RMarkdown."}
:::
...
[[bit.ly/quarto-params](https://jadeynryan.quarto.pub/parameterized-quarto-posit-2023/)]{style="font-size: 1.5em;font-weight: bold;"}
...
::: columns
::: {.column width="50%"}
{{< fa solid display >}} [Slides](https://jadeynryan.quarto.pub/parameterized-quarto-posit-2023/)
...
[![](images/qr.png){style="max-" fig-alt="QR code to slides." fig-align="left" height="300"}](https://bit.ly/quarto-params)
:::
