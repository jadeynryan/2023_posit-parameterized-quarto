...
format: 
  revealjs:
    ...
    footer: "[{{< fa solid display >}}  bit.ly/param-quarto](http://bit.ly/param-quarto)"
...
```{r, include = FALSE}
library(washi)
data <- read.csv("exampleData.csv", check.names = FALSE) |> 
...
::: r-stack
[![](images/ocean_floor.png){.fragment fig-alt="RStudio RMarkdown parameterized report project for mapping ocean floors."}](https://rmarkdown.rstudio.com/lesson-6.html)

[![](images/urban_institute.png){.fragment fig-alt="Report for Alabama spending with text and plots generated from parameterized RMarkdown."}](https://book.rwithoutstatistics.com/parameterized-reports-chapter.html)

[![](images/driver_quality.png){.fragment fig-alt="Report for Alaska driver quality with text, plot, and table generated from parameterized RMarkdown."}](https://urban-institute.medium.com/iterated-fact-sheets-with-r-markdown-d685eb4eafce)
:::

::: notes
Data don't make a difference, the people do. So it's our responsibility to make the data and results understandable and interpretable for the people who have the power to make a difference. Parameterized reports are one way to democratize data.
:::
...
::: {.column width="35%"}
::: fragment
![](images/confused_tai.jpg){fig-alt="Cat with an expression of existential dread" style="max-height:700px"}
:::
:::
:::

## 2021: RMarkdown \> MS Word \> PDF
...
::: {layout-ncol="2"}
![](images/2023_pg1.png){fig-alt="First page of 2023 example MS Word report" style="max-height:725px"}

![](images/2023_pg11.png){fig-alt="Page from example MS Word report showing soil texture triangle" style="max-height:725px"}
:::
...
## Don't worry about taking good notes

All slides with code snippets and resources are available at:

[[bit.ly/param-quarto](https://rpubs.com/jadeynryan/parameterized_quarto_posit2023)]{style="font-size: 1.5em;font-weight: bold;"}

[![](images/qr.png){fig-alt="QR code to slides." width="300"}](https://rpubs.com/jadeynryan/parameterized_quarto_posit2023)
...
Parameterized reports work with both `Knitr` and `Jupyter` engines.
...
```{markdown}
These are results for `r params$farmer` from `r params$year`.
```
...
![](images/surprise_mai.jpg){fig-alt="Surprised cat next to the surprised Pikachu meme." fig-align="center"}
...
::: notes
dummy punny farmer names from Chat GPT
:::
...
::: columns
::: {.column width="50%"}
Embed everything in your HTML file.
...
![](images/no_tabset.png){fig-alt="Screenshot of soil measurements without tabset in MS Word report."}
...
Use `out_type` in chunk options to control code evaluation.
...
::: {.fragment .column width="50%"}
![](images/tv_mai.jpg){fig-alt="Cat falling asleep in human's lap with a phone with video playing on the sleepy cat's belly." style="max-height:750px"}
:::
:::

## Example 2023 HTML Report: bit.ly/soil-html

[![](images/report_html.png){fig-alt="Beginning of 2023 example HTML report"}](https://wa-department-of-agriculture.github.io/soils/articles/html.html)

## Example 2023 MS Word Report: bit.ly/soil-docx

[![](images/2023_pg1.png){style="max-" fig-alt="First page of 2023 example MS Word report" height="750"}](https://wa-department-of-agriculture.github.io/soils/articles/docx.html)
...
::: columns
::: {.column width="50%"}
{{< fa solid display >}} [Slides](https://rpubs.com/jadeynryan/parameterized_quarto_posit2023)
...
[![](images/qr.png){style="max-" fig-alt="QR code to slides." fig-align="left" height="300"}](bit.ly.param-quarto)
:::

::: {.fragment .column width="50%"}
![](images/upside_down_skye.jpg)
:::
:::
